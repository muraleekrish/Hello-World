...
/* 	Creating the Home and Remote Objects 	*/
		...
		HashMap machineTypes = machineObj.getAllMachineTypes();
		
		pageContext.setAttribute("machineTypes",machineTypes);
...
<body onLoad="init()">
<html:form action="frmMachAdd" focus="machineCode">
  <table width="100%" height="100%" cellpadding="10" cellspacing="0">
    <tr> 
      <td valign="top"><table width="100%" cellpadding="0" cellspacing="0" id="PageTitle">
          <tr>
            <td><bean:message key="prodacs.machine.machineadd.header"/></td>
          </tr>
        </table>
        <br>
        ...
        <table width="100%" cellspacing="0" cellpadding="0">
          <tr> 
            <td class="FieldTitle"><bean:message key="prodacs.machine.machinecode"/><span class="mandatory">*</span></td>
            <td class="FieldTitle">:</td>
            <td class="FieldTitle"><html:text property="machineCode" styleClass="TextBox" size="10" maxlength="10" /></td>
          </tr>
          <tr> 
            <td width="120" class="FieldTitle"><bean:message key="prodacs.machine.machinename"/><span class="mandatory">*</span></td>
            <td width="1" class="FieldTitle">:</td>
            <td class="FieldTitle"><html:text property="machineName" styleClass="TextBox" size="50" maxlength="50" /></td>            
          </tr>
          <tr> 
            ...
            <td class="FieldTitle"><html:select property="machineType" styleClass="Combo">
                <html:option value="0">-- Choose Type --</html:option>
  					 <html:options collection="machineTypes" property="key" labelProperty="value"/>
              </html:select>
		</td>
          </tr>
          <tr> 
            ...
            <td class="FieldTitle"><html:text property="installationDate" styleClass="TextBox" size="12" readonly="true" />
              <img src='<bean:message key="context"/>/images/calendar.gif' name='calImg' align='absmiddle' onclick='show_calendar("installationDate",MachineAdd.installationDate.value,event.clientX,event.clientY,false)' onMouseOver="this.style.cursor='hand'"></td>
          </tr>
          <tr> 
        ...
        <table width="100%" cellpadding="0" cellspacing="0" id="BtnBg">
          <tr>
            <td><html:button property="addMachine" styleClass="Button" onclick="javascript:submitItem()">Add Machine</html:button>
          </tr>
        </table></td>
    </tr>
  </table>
