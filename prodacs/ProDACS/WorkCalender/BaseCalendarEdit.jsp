...
<script language="Javascript" type="text/Javascript">
	...
	function loadShiftDetails()
	{
		...
		for (var j = 0; j < obj.children.length; j++)
		{
			if (j != 0)
			{
				temp.hidShiftDetails.value = temp.hidShiftDetails.value + "^";
			}
			temp.hidShiftDetails.value = temp.hidShiftDetails.value +
		...
		//alert(temp.hidShiftDetails.value);
		var flag = false;
	...
	function modRow(formObj)
	{
		...
		for (var i = 0; i < obj.children.length; i++) // Placing values to appropriate positions
		{
			if (obj.children(i).children(0).children(0).children(0).checked)
			{
				temp.dayofWeek.selectedIndex = parseInt(obj.children(i).children(0).children(6).children(0).value,10);
	...
	function getShiftDetails()
	{
		...
		var shftDets = (temp.hidShiftDets.value).split("^");
		for (var i = 0; i < shftDets.length; i++)
		{
			var shftDet = shftDets[i].split("-");
			//alert(shftDet);
			...
			{
				obj.children(0).children(0).children(1).children(0).value = day;
				obj.children(0).children(0).children(2).children(0).value = shftDet[2];
				obj.children(0).children(0).children(3).children(0).value = shftDet[3]+"-"+shftDet[4];
				obj.children(0).children(0).children(4).children(0).value = shftDet[5]+"-"+shftDet[6];
				obj.children(0).children(0).children(5).children(0).value = shftDet[8];
				obj.children(0).children(0).children(6).children(0).value = shftDet[0];
				obj.children(0).children(0).children(7).children(0).value = shftDet[1];
				obj.children(0).children(0).children(8).children(0).value = shftDet[7];
			}
			else
			{
				...
				obj.children(len-1).children(0).children(1).children(0).value = day;
				obj.children(len-1).children(0).children(2).children(0).value = shftDet[2];
				obj.children(len-1).children(0).children(3).children(0).value = shftDet[3]+"-"+shftDet[4];
				obj.children(len-1).children(0).children(4).children(0).value = shftDet[5]+"-"+shftDet[6];
				obj.children(len-1).children(0).children(5).children(0).value = shftDet[8];
				obj.children(len-1).children(0).children(6).children(0).value = shftDet[0];
				obj.children(len-1).children(0).children(7).children(0).value = shftDet[1];
				obj.children(len-1).children(0).children(8).children(0).value = shftDet[7];
			}
		}
	}
...
<body onload="loadToHidden();  loadShiftDets();shiftDays(this.form);getShiftDetails();"><!--  -->
<html:form action="frmBaseClndrEdit" focus="baseCalendarName">
<html:hidden property="formAction"/>
<html:hidden property="id"/>
<html:hidden property="ids"/>
<html:hidden property="hidShiftDets"/>
<html:hidden property="hidShiftDetails"/>
...
<td>
	...
	<tr>
		...
		<td colspan="4" class="FieldTitle"><html:text property="baseCalendarName" readonly="true" styleClass="TextBox" size="40" maxlength="50" /></td>
	</tr>
	<tr>
	...
	<fieldset id="FieldSet"><legend><bean:message key="prodacs.workcalendar.basecalendar.shiftassignmentforeachday"/></legend><br>
		...
		<tr>
			<td>
				<html:button property="editBaseCalendar" styleClass="Button" onclick="javascript:loadShiftDetails()">Update</html:button>
			</td>
		</tr>
        </table>
</td>
