    ...
    <tr> 
      <td valign="top"><table width="100%" cellpadding="0" cellspacing="0" id="PageTitle">
		...
		%>
			...
			<tr> 
				<td width="69" class="TableItems"><input readonly name="serial" class="TextBoxFull" size="9" maxlength="10"></td>
				<td class="TableItems"><input readonly name="opnName" class="TextBoxFull" size="9" maxlength="10"></td>
				<td width="99" class="TableItems"><input readonly name="opnStdHrs" class="TextBoxFull" size="9" maxlength="10"></td>
				<td width="159" class="TableItems"><input readonly name="grpName" class="TextBoxFull" size="9" maxlength="10"></td>
			</tr>
			</table>
		<%
			}
