...
<html:html>
<head>
<title><bean:message key="prodacs.employee.employeeedit.titleheader"/></title>
...
<script language="Javascript" type="text/Javascript">
	...
	function newCustType()
	{
		...
		window.open('<bean:message key="context"/>/Customer/CustomerType.jsp?',"NewCustomer",features);
	}
	...
	function moveToHidden()
	{
		...
		temp.employeeDOJ.value = "";
		temp.employeeDOB.value = "";
		...
		//alert((temp.dobYear.value).length);
		if (temp.dobYear.value != "" && temp.dobMonth.value != "" && temp.dobDay.value != "")
		{
			if ((temp.dobYear.value).length != 4 || ((temp.dobMonth.value).length != 2 || temp.dobMonth.value > 12) || (temp.dobDay.value).length != 2)
			{
				alert("Date not in specified format!");
				return false;
			}
			else
			{
				...
				//alert("dob :"+temp.employeeDOB.value);
			}
		}
		dob = new Date();
		doj = new Date();
		...
		if (dob != "" || doj != "")
		{
			if (dob >= doj)
			{
				alert("Date of Birth cannot be higher (or) equal to Date of Joining");
				temp.dojYear.focus();
				return false;
			}
			else
	...
	{
		temp = document.forms[0];
		if (temp.employeeDOJ.value != "")
		{
			var dojDate = (temp.employeeDOJ.value).split("-");
			for (var i = 0; i < dojDate.length; i++)
			{
				temp.dojYear.value = dojDate[0];
				temp.dojMonth.value = dojDate[1];
				temp.dojDay.value = dojDate[2];
			}
		}
		if (temp.employeeDOB.value != "")
		{
			var dobDate = (temp.employeeDOB.value).split("-");
			for(var j = 0; j < dobDate.length; j++)
			{
				temp.dobYear.value = dobDate[0];
				temp.dobMonth.value = dobDate[1];
				temp.dobDay.value = dobDate[2];
			}
		}
	}
</script>
...
<body onLoad="init();loadToHidden();getDates();">
<html:form action="frmEmpEdit" focus="employeeType">
  ...
  <table width="100%" height="100%" cellpadding="10" cellspacing="0">
    <tr> 
      <td valign="top"><table width="100%" cellpadding="0" cellspacing="0" id="PageTitle">
          <tr>
            <td><bean:message key="prodacs.employee.employeemodify.header"/></td>
          </tr>
        </table>
        <br>
	...
	<td colspan='2'> <font size="1px" face="Verdana"><html:errors/></font></td>
        ...
        <table width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <td width="1" class="FieldTitle">:</td>
            <td class="FieldTitle"><html:text property="employeeName" styleClass="TextBox" size="50"/></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td class="FieldTitle"><html:select property="employeeStatus" styleClass="Combo">
              ...
              </html:select>&nbsp;&nbsp;<span class="TopLnk"><a href="#" onclick="newCustType();">New</a></span></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td class="FieldTitle">:</td>
               <td class="FieldTitle"><input name="dojYear" class="TextBox" size="4" tabindex="10" onkeypress="return isNumber(this);" onkeyup="checkLength(this,this.value); return isNumber(this);" maxlength="4"/> -
				<input name="dojMonth" class="TextBox" size="2" tabIndex="11" onkeypress="return isNumber(this);" onkeyup="checkLength(this,this.value);return isNumber(this);" maxlength="2"/> -
				<input name="dojDay" class="TextBox" size="2" tabIndex="12" onkeypress="return isNumber(this);" onkeyup="checkLength(this,this.value);return isNumber(this);" maxlength="2"/>
          ...
          <tr> 
            ...
            <td class="FieldTitle">:</td>
            <td class="FieldTitle"><input name="dobYear" class="TextBox" size="4" tabindex="13" onkeypress="return isNumber(this);" onkeyup="checkLength(this,this.value);return isNumber(this);" maxlength="4"/> -
				<input name="dobMonth" class="TextBox" size="2" tabIndex="14" onkeypress="return isNumber(this);" onkeyup="checkLength(this,this.value);return isNumber(this);" maxlength="2"/> -
				<input name="dobDay" class="TextBox" size="2" tabIndex="15" onkeypress="return isNumber(this);" onkeyup="checkLength(this,this.value);return isNumber(this);" maxlength="2"/>
			<font size="-5px"><bean:message key="prodacs.common.dateformat"/></td>
          </tr>
          <tr> 
        ...
        <table width="100%" cellpadding="0" cellspacing="0" id="BtnBg">
          <tr>
            <td>
              <html:button property="modifyEmployee" styleClass="Button" value = "Modify Employee Info" onclick="moveToHidden();"/> 
          </tr>
        </table></td>
    </tr>
  </table>
