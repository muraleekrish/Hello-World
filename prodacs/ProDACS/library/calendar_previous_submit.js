...
//	alert(str_buffer);
	...
	str_buffer +=">\n <a href=\"#\" style=\"color:black; text-decoration:none; font-size:12px; font-weight:bold\" onclick=\"parent.document.getElementById('"+str_target+"').value=document.cal.hidvalue.value;parent.oPopup.hide();parent.dateSubmit();\">Done</a>";
