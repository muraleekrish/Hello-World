...
<html:form action="frmGroupAdd" focus="groupName">
...
<tr> 
	...
	<tr>
		<td><bean:message key="prodacs.group.groupadd"/></td>
	</tr>
	</table><br>
	<table width="100" cellspacing="0" cellpadding="0" align="right">
	<tr>
 		<menuconfig:userRights url="#" id="#" onMouseOver="window.status='Add New Group Info'; return true"  onMouseOut="window.status=''; return true" resourceId="1029" text="[ Add ]" classId="TopLnk" onClick="javaScript:addGroupItem();"/>
...
<br>	
	...
	<tr> 
		<td width="110" class="FieldTitle"><bean:message key="prodacs.useradministration.groupname"/><span class="mandatory">*</td>
		<td width="1" class="FieldTitle">:</td>
		<td class="FieldTitle"><html:text property="groupName" styleClass="TextBox" size="50"/></td>
	</tr>
	<tr> 
	...
	<tr>
		<td class="FieldTitle">Resource Rights<span class="mandatory">*</td>
	</tr>
	</table>
	...
	<tr> 
		...
		<td width="75" align="center" class="TableItems2"><html:multibox property="selectedResource" value='1' /></td>
		<td width="90" align="center" class="TableItems2"><html:multibox property="selectedResource" value='1001' /></td>
	</tr>
	<tr> 
		<td class="TableItems">Customer</td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='2' /></td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='1002' /></td>
	</tr>	
	</table>
	...
	<tr> 
		...
		<td width="75" align="center" class="TableItems2"><html:multibox property="selectedResource" value='5' /></td>
		<td width="90" align="center" class="TableItems2"><html:multibox property="selectedResource" value='1005' /></td>
	</tr>
	<tr> 
		<td class="TableItems">Machine</td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='6' /></td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='1006' /></td>
	</tr>	
	<tr> 
		<td class="TableItems2">Operation Group</td>
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='7' /></td>
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='1007' /></td>
	</tr>	
	</table>
	...
	<tr> 
		...
		<td width="75" align="center" class="TableItems2"><html:multibox property="selectedResource" value='8' /></td>
		<td width="90" align="center" class="TableItems2"><html:multibox property="selectedResource" value='1008' /></td>
	</tr>
	<tr> 
		<td class="TableItems">Base Calendar</td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='9' /></td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='1009' /></td>
	</tr>	
	<tr> 
		<td class="TableItems2">Availability Calendar</td>
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='10' /></td>
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='1010' /></td>
	</tr>	
	</table>
	...
	<tr> 
		<td class="TableItems2">WorkOrder</td>
		<td width="75" align="center" class="TableItems2"><html:multibox property="selectedResource" value='13' /></td>
		<td width="90" align="center" class="TableItems2"><html:multibox property="selectedResource" value='1013' /></td>
	</tr>
	<tr> 
		<td class="TableItems">Dummy WorkOrder</td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='14' /></td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='1014' /></td>
	</tr>	
	<tr> 
		<td class="TableItems2">WorkOrder/JobClosing</td>
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='15' /></td>
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='1015' /></td>
	</tr>	
	<tr> 
		<td class="TableItems">Pre-Close Log</td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='16' /></td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='1016' /></td>
	</tr>	
	</table>
	
	<table width="400" cellpadding="0" cellspacing="0" id="woJbStatus">
	<tr>
	...
	<tr> 
		...
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='49' /></td>
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='1049' /></td>
	</tr>	
	<tr>
		<td class="TableItems">Despatch Clearance</td>
		<td width="75" align="center" class="TableItems"><html:multibox property="selectedResource" value='51' /></td>
		<td width="90" align="center" class="TableItems"><html:multibox property="selectedResource" value='1051' /></td>
	</tr>
	<tr>
		<td class="TableItems2">Final Posting</td>
		<td width="75" align="center" class="TableItems2"><html:multibox property="selectedResource" value='53' /></td>
		<td width="90" align="center" class="TableItems2"><html:multibox property="selectedResource" value='1053' /></td>
	</tr>
	</table>
	...
	<tr>
		<td class="TableItems2">Shipment Reference</td>
		<td width="75" align="center" class="TableItems2"><html:multibox property="selectedResource" value='52' /></td>
		<td width="90" align="center" class="TableItems2"><html:multibox property="selectedResource" value='1052' /></td>
	</tr>
	<tr>
		<td class="TableItems">Shipment Posting</td>
		<td width="75" align="center" class="TableItems"><html:multibox property="selectedResource" value='54' /></td>
		<td width="90" align="center" class="TableItems"><html:multibox property="selectedResource" value='1054' /></td>
	</tr>
	</table>
	...
	<tr> 
		<td class="TableItems2">Payroll Id</td>
		<td width="75" align="center" class="TableItems2"><html:multibox property="selectedResource" value='41' /></td>
		<td width="90" align="center" class="TableItems2"><html:multibox property="selectedResource" value='1041' /></td>
	</tr>
	<tr> 
		<td class="TableItems">Payroll Interface</td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='23' disabled="true"/></td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='1023' /></td>
	</tr>	
	<tr> 
		<td class="TableItems2">Payroll</td>
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='24' disabled="true"/></td>
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='1024' /></td>
	</tr>	
	<tr> 
		<td class="TableItems">Payroll Adjustment</td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='25' disabled="true"/></td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='1025' /></td>
	</tr>	
	<tr> 
		<td class="TableItems2">Close Payroll</td>
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='26' disabled="true"/></td>
		<td align="center" class="TableItems2"><html:multibox property="selectedResource" value='1026' /></td>
	</tr>	
	</table>
	...
	<table width="400" cellpadding="0" cellspacing="0">
	<tr>
		<td class="TableItems"><strong><a href="javascript:mkRights(document.getElementById('graphs'))">Graphs</a></strong></td>
		<td align="center" width="75" class="TableItems"><input type="checkbox" name="graphsRead" value="checkbox" onclick='callCk(this,"108","3")'>
		</td>
		<td align="center" width="90" class="TableItems"><input type="checkbox" name="graphsWrite" value="checkbox" onclick='callCk(this,"109","3")'>
		</td>
	</tr>
	</table>
	...
	<tr> 
		...
		<td width="75" align="center" class="TableItems2"><html:multibox property="selectedResource" value='59' /></td>
		<td width="90" align="center" class="TableItems2"><html:multibox property="selectedResource" value='1059' /></td>
	</tr>
	<tr> 
		<td class="TableItems">Idle/BreakDown Chart</td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='60' /></td>
		<td align="center" class="TableItems"><html:multibox property="selectedResource" value='1060' /></td>
	</tr>	
	<tr> 
		<td class="TableItems2">Employee Performance Chart</td>
		<td width="75" align="center" class="TableItems2"><html:multibox property="selectedResource" value='58' /></td>
		<td width="90" align="center" class="TableItems2"><html:multibox property="selectedResource" value='1058' /></td>
	</tr>
	</table>
	<br>
	<table width="100%" cellpadding="0" cellspacing="0" id="BtnBg">
	<tr>
		<td><html:button property="adduser" styleClass="Button" value="Add Group" onclick="addGroup();"/>
	</tr>
	</table></td>
</tr>
</table>
