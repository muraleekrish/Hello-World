...
<%
	if (BuildConfig.DMODE)
		System.out.println("Salary Report Email Starts...");
	...
	if ((month != "") && (year != ""))
	{
		try
		{
			...
			mailAttachmentName = "Monthly Report for "+strMonth+" ' "+year+".pdf";
...
%>
	...
	<form name="frmMonthlyReportEmail">
<%
	if (BuildConfig.DMODE)
...
<%
	...
	{
%>
	<jsp:forward page='MonthlyReport.jsp'>
