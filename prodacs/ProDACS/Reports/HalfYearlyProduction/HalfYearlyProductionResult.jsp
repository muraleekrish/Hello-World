...
<%
	if (BuildConfig.DMODE)
		System.out.println("Half Yearly Production Result Starts...");
...
%>
		...
		<script>
			...
			function pdfReport()
			{
				...
				document.forms[0].action='<bean:message key="context"/>/Reports/HalfYearlyProduction/HalfYearlyProductionResult.jsp';
		...
		<form name="frmHalfYearlyProductionResult">
