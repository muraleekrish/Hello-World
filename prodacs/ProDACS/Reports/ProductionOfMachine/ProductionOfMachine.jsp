...
<body onload="init()">
<form name="frmProdMachine"  onsubmit="return validate()" action='<bean:message key="context"/>/Reports/ProductionOfMachine/ProductionOfMachineResult.jsp'>
<table width="100%" cellspacing="0" cellpadding="10">
<tr>
<td valign="top">
	<table width="100%" cellpadding="0" cellspacing="0" id="PageTitle">
	<tr>
         	<td><bean:message key="prodacs.reports.productionofmachine.title"/></td>
	</tr>
	</table>
...
%>	                		
			...
			<td width="1" class="FieldTitle">:</td>
			<td width="100" class="FieldTitle"><input name="startDate" type="text" class="TextBox" readonly size="11"> 
			<img src='<bean:message key="context"/>/images/calendar.gif' name='calImg' align='absmiddle' onclick='show_calendar("startDate",frmProdMachine.startDate.value,event.clientX,event.clientY,false)' onMouseOver="this.style.cursor='hand'"></td>
			...
			<img src='<bean:message key="context"/>/images/calendar.gif' name='calImg' align='absmiddle' onclick='show_calendar("endDate",frmProdMachine.endDate.value,event.clientX,event.clientY,false)' onMouseOver="this.style.cursor='hand'"></td>
		</tr>
	</table>
	<br>
