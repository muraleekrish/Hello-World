...
<%
	if (BuildConfig.DMODE)
		System.out.println("Machine Utilization Starts...");
...
%>
		...
		<script>
			...
			function pdfReport()
			{
				...
				document.forms[0].action='<bean:message key="context"/>/Reports/MachineUtilization/MachineUtilizationResult.jsp';
		...
		<form name="frmMachineUtilizationResult">
