...
<%
	if (BuildConfig.DMODE)
		System.out.println("Employee Performance Email Starts.");
	...
	String employeeName = request.getParameter("employeeName"); /* This is Employee ID */
	
	if ((startDate != "") && (endDate != "") && (empName != "") && (empTypName != ""))
	{
		/* For Start Date */
		...
		try
		{
			...
			SessionReportsDetailsManagerHome empHomeObj = (SessionReportsDetailsManagerHome)PortableRemoteObject.narrow(obj.getHome(),SessionReportsDetailsManagerHome.class);
			SessionReportsDetailsManager empObj = (SessionReportsDetailsManager)PortableRemoteObject.narrow(empHomeObj.create(),SessionReportsDetailsManager.class);

			empPerDetObj = empObj.fetchEmployeePerformance(ge.getTime(),ge1.getTime(),Integer.parseInt(employeeName));
			...
			if (BuildConfig.DMODE)
			{
				...
				System.out.println("Emp Id: "+ employeeName);
				System.out.println("Emp Typ Name: "+ empTypName);
				System.out.println("Emp Name: "+ empName);
			}
			
			mailAttachmentName = "Performance of "+empTypName+" "+empName+" from "+stDate+" to "+edDate+".pdf";
			...
			parameters.put("empId",employeeName);
...
<%
	...
	{
%>
	<jsp:forward page='EmployeePerformance.jsp'>	
