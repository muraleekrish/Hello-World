...
<%
	...
	if ((startDate != "") && (endDate != ""))
	{
		...
		try
		{
			...
			SessionReportsDetailsManagerHome qtyHomeObj = (SessionReportsDetailsManagerHome)PortableRemoteObject.narrow(obj.getHome(),SessionReportsDetailsManagerHome.class);
			SessionReportsDetailsManager qtyObj = (SessionReportsDetailsManager)PortableRemoteObject.narrow(qtyHomeObj.create(),SessionReportsDetailsManager.class);

			objQuantityProducedDetails = qtyObj.fetchQuantityProducedDetails(ge.getTime(),ge1.getTime());
			...
			mailAttachmentName = "Quantity_Produced_From_"+stDate+"_To_"+edDate+".pdf";
...
<%
	...
	{
%>
	<jsp:forward page='QuantityProduced.jsp'>	
