...
<body onload="init()">
<form name="frmIdleBreakDown"  onsubmit="return validate()" action='<bean:message key="context"/>/Reports/IdleBreakDown/IdleBreakDownResult.jsp'>
<table width="100%" cellspacing="0" cellpadding="10">
<tr>
<td valign="top">
	<table width="100%" cellpadding="0" cellspacing="0" id="PageTitle">
	<tr>
         	<td>Idle & BreakDown</td>
	</tr>
	</table>
	...
	<table width="100%" cellspacing="0" cellpadding="0">
		<tr>
			...
			<img src='<bean:message key="context"/>/images/calendar.gif' name='calImg' align='absmiddle' onclick='show_calendar("startDate",frmIdleBreakDown.startDate.value,event.clientX,event.clientY,false)' onMouseOver="this.style.cursor='hand'"></td>
			...
			<img src='<bean:message key="context"/>/images/calendar.gif' name='calImg' align='absmiddle' onclick='show_calendar("endDate",frmIdleBreakDown.endDate.value,event.clientX,event.clientY,false)' onMouseOver="this.style.cursor='hand'"></td>
		</tr>
	</table>
	<br>
