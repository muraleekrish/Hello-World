...
public class EmployeeAddForm extends ActionForm 
{
	...
	{ 
		...
		if(employeeName==null || employeeName.trim().length()<1 || employeeName.trim().equals(""))
			errors.add(ActionErrors.GLOBAL_ERROR, new ActionError("prodacs.common.error.required","EmployeeName"));
		...
		if(employeeCode==null || employeeCode.trim().equals("0"))
			errors.add(ActionErrors.GLOBAL_ERROR, new ActionError("prodacs.common.error.required","EmployeeCode"));
...
/***
$Log: EmployeeAddForm.java,v $
Revision 1.8  2005/08/17 10:19:24  vkrishnamoorthy
Fields added.

Revision 1.7  2005/08/01 06:26:30  vkrishnamoorthy
Employee code added.

Revision 1.6  2005/07/26 11:11:56  vkrishnamoorthy
DMODE added to avid System.out.println()'s.

Revision 1.5  2005/05/27 11:58:44  vkrishnamoorthy
Date validations remodified.

Revision 1.4  2005/05/11 13:47:24  vkrishnamoorthy
