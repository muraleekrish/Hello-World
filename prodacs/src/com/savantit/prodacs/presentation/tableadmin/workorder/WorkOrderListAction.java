...
public class WorkOrderListAction extends Action 
{
			...
			HttpServletResponse response)
	{
		...
		/* Create an instanceof WorkOrderListForm.java*/
		if (form instanceof WorkOrderListForm)
		{
			//WorkOrderListForm frm = (WorkOrderListForm)form;
			action = "success";
		}
		if (BuildConfig.DMODE)
        {
			System.out.println("WorkOrder List: "+action);
        }
		return mapping.findForward(action);
	}
}
/***
$Log: WorkOrderListAction.java,v $
